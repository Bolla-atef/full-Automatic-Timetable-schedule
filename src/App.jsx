...
import LearnMore from './components/Learnmore/Learnmore';
import CollegeSelectPage from './components/CollegeSelect/CollegeSelectPage';
...
function App() {
  let x= createBrowserRouter([
    {path:'',element:<Layout/>,children:[
      ...
      {path:'professors',element:<ProtectedRouting><Professors/></ProtectedRouting>},
      ...
      {path:'select-college',element:<CollegeSelectPage/>},
