    ...
    const fetchClassroomData = async () => {
      try {
        ...
        const [sectionResponse, emptyResponse] = await Promise.all([
          axios.get(
            `${import.meta.env.VITE_API_URL}/api/AnalysisAndStatisticals/SectionClassRoom`,
            {
              headers: {
          ...
          axios.get(
            `${import.meta.env.VITE_API_URL}/api/AnalysisAndStatisticals/ClassRoomSectionNotMapped`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
                "Content-Type": "application/json",
