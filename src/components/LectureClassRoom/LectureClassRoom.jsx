    ...
    const fetchClassroomData = async () => {
      try {
        ...
        const [lectureResponse, emptyResponse] = await Promise.all([
          axios.get(
            `${import.meta.env.VITE_API_URL}/api/AnalysisAndStatisticals/LectureClassRoom`,
            {
              headers: {
          ...
          axios.get(
            `${import.meta.env.VITE_API_URL}/api/AnalysisAndStatisticals/ClassRoomLectureNotMapped`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
                "Content-Type": "application/json",
