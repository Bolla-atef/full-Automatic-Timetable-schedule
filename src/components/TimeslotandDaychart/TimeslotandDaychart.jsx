        ...
        const fetchData = async () => {
            try {
                ...
                const [daysResponse, timeSlotsResponse] = await Promise.all([
                    axios.get(`${import.meta.env.VITE_API_URL}/api/AnalysisAndStatisticals/TotalDays`, {
                        headers: {
                    ...
                    axios.get(`${import.meta.env.VITE_API_URL}/api/AnalysisAndStatisticals/TotalTimeSlot`, {
                        headers: {
                            Authorization: `Bearer ${token}`,
                            "Content-Type": "application/json",
                        },
